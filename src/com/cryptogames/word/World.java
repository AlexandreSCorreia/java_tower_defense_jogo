...
import com.cryptogames.entities.Spawner;
...
public class World {
			...
			for(int xx=0; xx< map.getWidth();xx++) {
				for(int yy= 0; yy< map.getHeight();yy++) {
					...
					if(pixelAtual == 0xff000000) {
						...
						tiles[xx + (yy*WIDTH)] = new TargetTile(xx*16,yy*16,Tiles.TILE_FLOOR);
						xFINAL = xx;
						yFINAL = yy;
	...
	public static void RestartGame() {
		//TODO:Aplicar metodo para reeiniciar o jogo corretamente
